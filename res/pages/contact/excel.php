...
$user = "spmacay"; // your db's privileged user account
$password = "spmacay@671"; // and it's password
$db_name = "spicmacayDb"; // db name
$tbl_name = "contact"; // table name of the selected db
...
header("Content-Disposition: attachment; filename=spicmacay.xls");
